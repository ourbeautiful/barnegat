...
- **New signature element**: a paw-print "trail" motif (see `_includes/icons/paw.svg` and `.trail-divider` / `.programs-trail` in the CSS), distinct from OBA's "seats at the table" motif
